...
export const App = () => {
  ...
  const handleClick = (selector: string) => {
    ...
    const obj: DrumElement | undefined = arr.find(
      (element: DrumElement) => element.text === selector
    );
  ...
  return (
    <div id="drum-machine" className="vh-100 container-fluid">
      ...
      <div
        id="display"
        className="border border-dark border-5 rounded text-white bg-secondary fw-bold fst-italic fs-3"
      >
        {text}
      </div>
    </div>
